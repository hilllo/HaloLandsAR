...
namespace HoloToolkit.Unity
{
    ...
    public class WorldAnchorManager : Singleton<WorldAnchorManager>
    {
...
#else
            GameObject debugModeObject = GameObject.Find(anchorName + "Debug");
            gameObjectToAnchor.transform.position = debugModeObject.transform.position;
            gameObjectToAnchor.transform.rotation = debugModeObject.transform.rotation;
        ...
        //Delete from anchor store
        public void DeleteAnchorfromAnchorStore(string anchorName)
        {
#if UNITY_WSA && !UNITY_EDITOR
            // This case is unexpected, but just in case.
            if (AnchorStore == null)
        ...
        private void CreateAnchor(GameObject gameObjectToAnchor, string anchorName)
        {
            ...
            Debug.Log(gameObjectToAnchor.name + " : World anchor created for this game object.");
